...
- Clone this Repo using `git clone https://github.com/riki-tanaka/Decentralized-eCommerce.git` 
...
* Open the file named 'EthereumSetup.js' (`Decentralized-eCommerce/frontend/src/EthereumSetup.js`)
